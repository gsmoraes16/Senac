...
public class Formulario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione", "Quilomêtro (KM)", "Metro (M)", "Decímetro (DM)", "Centímetro (CM)", "Milímetro (MM)" }));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione", "Quilomêtro (KM)", "Metro (M)", "Decímetro (DM)", "Centímetro (CM)", "Milímetro (MM)" }));

        btnLimpar.setFont(new java.awt.Font("Arial", 3, 16)); // NOI18N
